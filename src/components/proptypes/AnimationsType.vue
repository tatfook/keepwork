<template>
  <div class="menu-type">
    <el-button plain type='primary' @click="openAnimationsDialog">Add References</el-button>
...
<script>
import animationsDataEditor from "./animationsDataEditor";
export default {
  name: 'AnimationsType',
  props: {
    editingKey: String,
