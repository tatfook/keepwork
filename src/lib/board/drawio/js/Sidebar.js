...
import MxDictionary from '@/lib/board/mxGraph/util/MxDictionary'
import Editor from './Editor'
import Graph, { HoverIcons } from './Graph'
import Dialog from '@/lib/board/Dialog'
import MxCell from '@/lib/board/mxGraph/model/MxCell'
import MxEventObject from '@/lib/board/mxGraph/util/MxEventObject'
import MxGeometry from '@/lib/board/mxGraph/model/MxGeometry'
...
import MxDragSource from '@/lib/board/mxGraph/util/MxDragSource'
import MxCodec from '@/lib/board/mxGraph/io/MxCodec'
import MxGraphModel from '@/lib/board/mxGraph/model/MxGraphModel'
