 ...
 * - "aspect", optional string. Either "letiable", the default, or "fixed". Fixed
 * means always render the shape with the aspect ratio defined by the ratio w/h.
 * letiable causes the ratio to match that of the geometry of the current vertex.
...
export default class mxStencil {
  constructor(desc) {
    this.desc = desc
...
/**
 * letiable: defaultLocalized
 *
 * Static global letiable that specifies the default value for the localized
...
mxStencil.prototype.parseDescription = function() {
  ...
  // Possible values for aspect are: letiable and fixed where
  // letiable means fill the available space and fixed means
