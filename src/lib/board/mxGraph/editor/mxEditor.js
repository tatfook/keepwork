...
MxEditor.prototype.setGraphContainer = function(container) {
  if (this.graph.container === null) {
    ...
    if (MxClient.IS_QUIRKS) {
      let MxDivR = new MxDivResizer(container)
      MxDivR()
    }
  }
}
...
MxEditor.prototype.installDrillHandler = function(graph) {
  let listener = MxUtils.bind(this, function(sender) {
...
MxEditor.prototype.createProperties = function(cell) {
  ...
  if (MxUtils.isNode(value)) {
    ...
    let okFunction = MxUtils.bind(this, function() {
      // Hides the dialog
      this.hideProperties()
    ...
    let cancelFunction = MxUtils.bind(this, function() {
      // Hides the dialog
      this.hideProperties()
    })
...
MxEditor.prototype.showTasks = function() {
  if (this.tasks === null) {
    ...
    let funct = MxUtils.bind(this, function(sender) {
      MxEvent.release(div)
      div.innerHTML = ''
...
MxEditor.prototype.consumeCycleAttribute = function(cell) {
  return this.cycleAttributeValues !== null &&
    ...
    this.graph.isSwimlane(cell) ? this.cycleAttributeValues[ this.cycleAttributeIndex++ % this.cycleAttributeValues.length ]
    : null
}
