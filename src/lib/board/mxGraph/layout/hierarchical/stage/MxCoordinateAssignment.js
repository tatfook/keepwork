...
export default class MxCoordinateAssignment {
    ...
    for (let j = weightedValues[i].rankIndex - 1; j >= 0;) {
      ...
      if (weightedValue !== null) {
        ...
        if (weightedValue.visited) {
          ...
          // in-between
          leftLimit = leftCell
            .getGeneralPurposeVariable(rankValue) + leftCell.width / 2.0 + this.intraCellSpacing + leftBuffer + cell.width / 2.0
          j = -1
        } else {
      ...
      if (weightedValue !== null) {
        ...
        if (weightedValue.visited) {
          ...
          rightLimit = rightCell
            .getGeneralPurposeVariable(rankValue) - rightCell.width / 2.0 - this.intraCellSpacing - rightBuffer - cell.width / 2.0
...
MxCoordinateAssignment.prototype.setEdgePosition = function(cell) {
  ...
  if (cell.temp[0] !== 101207) {
    ...
    let layoutReversed = this.orientation === MxConstants.DIRECTION_EAST || this.orientation === MxConstants.DIRECTION_SOUTH
    ...
    for (let i = 0; i < cell.edges.length; i++) {
      ...
      // Declare letiables to define loop through edge points and
