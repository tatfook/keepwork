  ...
  <div class="textbook-page">
    <div class="textbook-page-book">
      <div class="textbook-page-book-left">
        <el-carousel height="268px" :interval="2000" arrow="always">
          <el-carousel-item v-for="(i,index) in books" :key="index">
            <img :src="i.imgUrl" alt="">
          </el-carousel-item>
        </el-carousel>
        <!-- <i class="el-icon-search search-bar-comp-button"></i>
        <div class="commodity-magnify"></div> -->
      </div>
    ...
    <div class="textbook-page-foreword">
      ...
      <div class="textbook-page-foreword-intro">
        ...
        <div class="textbook-page-foreword-intro-more">阅读更多</div>
      </div>
    </div>
      ...
      <div class="textbook-page-information-box">
        ...
        <div class="textbook-page-information-box-cover">
          ...
          <div class="textbook-page-information-box-cover-img">
            ...
            <p class="textbook-page-information-box-cover-img-title">Paracraft</p>
          </div>
        </div>
      </div>
      <div class="textbook-page-information-box">
        ...
        <div class="textbook-page-information-box-cover">
          <div class="textbook-page-information-box-cover-img">
            ...
            <p class="textbook-page-information-box-cover-img-title" @click="showPurchaseDialog(1)">Paracraft创意空间入门</p>
          </div>
          <div class="textbook-page-information-box-cover-img">
            <img class="textbook-page-information-box-cover-img-image" src="@/assets/org/相似性与相似原理.png" alt="" @click="showPurchaseDialog(2)">
            <p class="textbook-page-information-box-cover-img-title" @click="showPurchaseDialog(2)">相似性与相似原理</p>
          </div>
        </div>
      </div>
    </div>
  ...
  data() {
    return {
      books: [
        ...
        {
          imgUrl: require('@/assets/org/Paracraft创意空间入门.png')
        }
        // {
        //   imgUrl: require('@/assets/org/相似性与相似原理.png')
        // },
      ],
  ...
  methods: {
    ...
    showPurchaseDialog(index){
      switch (index) {
        ...
        this.purchaseMethodsImagesBookAuthor = '作者：于平、李玉霞、鞠慧敏',
        this.purchaseMethods = [
          {label: '去京东购买', purchaseUrl: 'https://search.jd.com/Search?keyword=Paracraft%E5%88%9B%E6%84%8F%E5%8A%A8%E7%94%BB%E5%85%A5%E9%97%A8&enc=utf-8&wq=Paracraft%E5%88%9B%E6%84%8F%E5%8A%A8%E7%94%BB%E5%85%A5%E9%97%A8&pvid=9e8b9bb5cce747b2aa60594645623257'},
          {label: '去当当购买', purchaseUrl: 'http://search.dangdang.com/?key=Paracraft%B4%B4%D2%E2%B6%AF%BB%AD%C8%EB%C3%C5&act=input'},
          {label: '去亚马逊购买', purchaseUrl: 'https://www.amazon.cn/gp/offer-listing/B076M9MG9Q/ref=sr_1_1_olp?__mk_zh_CN=%E4%BA%9A%E9%A9%AC%E9%80%8A%E7%BD%91%E7%AB%99&keywords=Paracraft%E5%88%9B%E6%84%8F%E5%8A%A8%E7%94%BB%E5%85%A5%E9%97%A8&qid=1557217364&s=gateway&sr=8-1'},
          {label: '去淘宝购买', purchaseUrl: 'https://s.taobao.com/search?q=Paracraft%E5%88%9B%E6%84%8F%E5%8A%A8%E7%94%BB%E5%85%A5%E9%97%A8&imgfile=&js=1&stats_click=search_radio_all%3A1&initiative_id=staobaoz_20190507&ie=utf8'},
          {label: '去清华大学出版社官网购买', purchaseUrl: 'http://www.tup.tsinghua.edu.cn/booksCenter/BOOK_07646101.html'},
          {label: '去中国图书网购买', purchaseUrl: 'http://www.bookschina.com/book_find2/?stp=Paracraft%u521B%u610F%u52A8%u753B%u5165%u95E8&sCate=0'},
          {label: '去孔夫子旧书网购买', purchaseUrl: 'http://search.kongfz.com/product_result/?key=Paracraft%E5%88%9B%E6%84%8F%E5%8A%A8%E7%94%BB%E5%85%A5%E9%97%A8&status=0&_stpmt=eyJzZWFyY2hfdHlwZSI6ImFjdGl2ZSJ9'}
        ]
