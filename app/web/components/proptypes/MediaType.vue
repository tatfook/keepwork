<template>
  <div class="media-type">
    ...
    <sky-drive-manager-dialog :isApplicable='true' :isVideoShow='isVideoTabShow' :isNoMediaFileShow="false" :show='isSkyDriveManagerDialogShow' @close='closeSkyDriveManagerDialog' />
  </div>
</template>
<script>
