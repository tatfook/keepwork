  ...
  <div class="historical-class-comp">
    ...
    <div class="historical-class-comp-form">
      ...
      <div class="historical-class-comp-form-item">
        ...
        <el-tree ref="lessonTree" v-loading='isTreeLoading' class="historical-class-comp-form-tree" :data='formatedTreeData' default-expand-all show-checkbox check-on-click-node :expand-on-click-node='false' node-key="id">
        </el-tree>
      </div>
    </div>
  </div>
