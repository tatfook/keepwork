<template>
  <div class="use-formal-code" v-loading="isLoading">
    <div class="use-formal-code-header">
      <div class="left">
    ...
    <div class="use-formal-code-step2" v-show="step==2">
      ...
      <div class="container">
        ...
        <invitation-code-types ref="codeTypesRef" :isTryShow="false" />
        <div class="item">
